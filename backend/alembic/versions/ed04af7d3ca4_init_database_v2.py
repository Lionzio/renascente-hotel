...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('FREE', 'OCCUPIED', 'TO_BE_CLEANED', 'TO_BE_VACATED', 'MAINTENANCE', name='roomstatus'), nullable=False),
    ...
    op.create_table('cleaning_records',
    sa.Column('id', sa.Integer(), nullable=False),
